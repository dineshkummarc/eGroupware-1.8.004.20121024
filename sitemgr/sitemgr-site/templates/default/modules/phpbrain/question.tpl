<form name="search" method=POST action={form_search_action}>
	<table width=100% style='border:1px solid black; margin-bottom:5px'>
		<tr>
			<td colspan=3 class=divSideboxHeader style='text-align:left'><b>{lang_search_kb}:</b></td>
		</tr>
		<tr>
...
<form method=POST action="{form_question_action}">
	<table width=100%>
		<tr>
			<td class=divSideboxHeader style='text-align:left' colspan=2><b>{lang_post_question}:</b></td>
		</tr>
		<tr>
